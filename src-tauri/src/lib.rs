...
pub fn run() {
  tauri::Builder::default()
    ...
    .setup(|app| {
      ...
      // Initialize Forge backend state
      let backend_url = std::env::var("FORGE_BACKEND_URL")
        .unwrap_or_else(|_| "http://localhost:8000".to_string());
      log::info!("Forge backend URL: {}", backend_url);
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      // Forge Backend Integration Commands
      commands::check_forge_health,
      commands::check_backend_connected,
      commands::get_cache_stats,
      commands::get_available_models,
      commands::open_url,
      commands::show_notification,
      // Forge Model Hotswap Commands
