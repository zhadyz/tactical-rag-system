/**
 * Desktop footer component - extends Nextra's built-in footer
 *
 * Features:
        ...
        <div className="flex flex-col items-center justify-between gap-6 text-sm md:flex-row">
          <div className="flex flex-col items-center gap-2 text-gray-600 dark:text-gray-400 md:items-start">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-500">
              Built with <a href="https://nextra.site" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400">Nextra</a> • <a href="https://github.com/shuding/nextra/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400">MIT License</a>
            </div>
          </div>
