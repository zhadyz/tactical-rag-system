...
description: Deep dive into Forge's multi-layer integration architecture, pipeline stages, and cross-component communication patterns.
---
...
Forge employs a sophisticated three-tier architecture with dual communication patterns optimized for both native OS integration and high-throughput data transfer.

## Integration Overview

### Communication Architecture

Forge uses **dual communication** for optimization:
...
#[tauri::command]
async fn check_forge_health() -> Result<HealthStatus, String> {
...
<Callout type="success">
**Continue Learning**: Now that you understand how Forge's layers integrate, dive into [Core Concepts](/core-concepts) to learn about the RAG engine, retrieval strategies, and caching mechanisms.
</Callout>
