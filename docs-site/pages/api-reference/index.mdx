...
1. **Embedding Cache:** Stores vector embeddings for repeated queries
2. **Response Cache:** Caches complete answers for identical questions
3. **Collection Metadata Cache:** Optimized document metadata loading
...
<Callout type="success">
  **Ready to integrate Apollo?** Check out the [interactive playground](/playground) to test queries in your browser.
</Callout>

## Next Steps

- **[Quick Start](/getting-started/quick-start)** - Get Apollo running in 5 minutes
- **[Architecture](/architecture)** - Understand how Apollo works
