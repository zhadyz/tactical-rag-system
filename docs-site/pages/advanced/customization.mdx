...
description: Extend Forge with custom models, retrieval strategies, and plugins
---
...
Forge is designed with extensibility at its core. This guide shows you how to customize components, integrate new models, and extend the system for your specific needs.

## Customization Overview

Forge provides multiple extension points across its architecture:
...
Forge supports multiple LLM backends through the factory pattern. To add a new backend:
...
**Version Compatibility**: Test extensions against the target Forge version. Extension APIs maintain backward compatibility within major versions.
</Callout>
