      ...
      <div className="flex-1 min-w-0 space-y-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {!isUser && message.isStreaming && (
            <span className="inline-flex items-center gap-1.5 px-2 py-1 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 rounded-lg text-xs font-medium">
        ...
        {!isUser && message.sources && message.sources.length > 0 && (
          <div className="mt-5 space-y-3">
            ...
            >
              {showSources ? (
                <ChevronUp size={16} className="transition-transform group-hover/sources:translate-y-[-1px]" />
              ) : (
                <ChevronDown size={16} className="transition-transform group-hover/sources:translate-y-[1px]" />
              )}
              <span>
